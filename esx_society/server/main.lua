...
RegisterServerEvent('esx_society:putVehiclezhjhoihyyqzctzgdglphckdpskldupacInGarage')
AddEventHandler('esx_society:putVehiclezhjhoihyyqzctzgdglphckdpskldupacInGarage', function(societyName, vehicle)
...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
	local xPlayer = ESX.GetPlayerFromId(source)
	local isBoss = xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'vice'
...
ESX.RegisterServerCallback('esx_society:setJobSalary2', function(source, cb, job2, grade2, salary)
	local isBoss2 = isPlayerBoss2(source, job2)
	local identifier = ESX.GetPlayerFromId(source).identifier
...
ESX.RegisterServerCallback('esx_society:getOnlzhjhoihyyqzctzgdglphckdpskldupacinePlayers', function(source, cb)
	local xPlayers = ESX.GetPlayers()
	local players  = {}
...
ESX.RegisterServerCallback('esx_society:getOnlzhjhoihyyqzctzgdglphckdpskldupacinePlayers2', function(source, cb)
	local xPlayers = ESX.GetPlayers()
	local players  = {}
...
function isPlayerBoss(playerId, job)
	...
	if xPlayer.job.name == job and (xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'vice') then
